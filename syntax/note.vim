...
hi hlightLine term=bold cterm=bold gui=bold ctermbg=green guibg=green
...
hi codeFoldStart term=bold cterm=bold gui=bold ctermbg=green guibg=green
hi codeFoldEnd term=bold cterm=bold gui=bold ctermbg=green guibg=green
